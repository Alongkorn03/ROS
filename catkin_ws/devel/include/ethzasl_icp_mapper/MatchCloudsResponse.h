...
bool operator==(const ::ethzasl_icp_mapper::MatchCloudsResponse_<ContainerAllocator1> & lhs, const ::ethzasl_icp_mapper::MatchCloudsResponse_<ContainerAllocator2> & rhs)
{
