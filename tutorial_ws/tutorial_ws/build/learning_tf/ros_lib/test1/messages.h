#ifndef _ROS_test1_messages_h
#define _ROS_test1_messages_h
  ...
  class messages : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 7) = (u_id.base >> (8 * 7)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->fl);
      ...
      *(outbuffer + offset + 0) = (this->another_field >> (8 * 0)) & 0xFF;
      offset += sizeof(this->another_field);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      this->id = u_id.real;
      offset += sizeof(this->id);
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->fl));
      ...
      this->another_field =  ((uint8_t) (*(inbuffer + offset)));
      offset += sizeof(this->another_field);
     return offset;
    }

    virtual const char * getType() override { return "test1/messages"; };
    virtual const char * getMD5() override { return "4f801381feac4b323373c99609c73f67"; };
