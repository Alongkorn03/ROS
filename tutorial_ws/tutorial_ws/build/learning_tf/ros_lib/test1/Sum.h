#ifndef _ROS_SERVICE_Sum_h
#define _ROS_SERVICE_Sum_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SUM[] = "test1/Sum";

  class SumRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SUM; };
    virtual const char * getMD5() override { return "02f05bb5bde9ff0aeeed7cca0d2e13fc"; };

  };

  class SumResponse : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SUM; };
    virtual const char * getMD5() override { return "055d509888d173367b1b9f94491341fd"; };
