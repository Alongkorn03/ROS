...
set(MSG_I_FLAGS "-Itest1:/home/kittiwut/tutorial_ws/src/test1/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/kittiwut/tutorial_ws/src/test1/msg/messages.msg" NAME_WE)
add_custom_target(_test1_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test1" "/home/kittiwut/tutorial_ws/src/test1/msg/messages.msg" "geometry_msgs/Point"
)

get_filename_component(_filename "/home/kittiwut/tutorial_ws/src/test1/srv/Sum.srv" NAME_WE)
add_custom_target(_test1_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test1" "/home/kittiwut/tutorial_ws/src/test1/srv/Sum.srv" ""
)
...
_generate_msg_cpp(test1
  "/home/kittiwut/tutorial_ws/src/test1/msg/messages.msg"
  "${MSG_I_FLAGS}"
...
_generate_srv_cpp(test1
  "/home/kittiwut/tutorial_ws/src/test1/srv/Sum.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/test1
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test1)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test1\")")
  # install generated code
  install(
